...
import np.com.drone.data.payload.response.AvailableDroneResponse;
import np.com.drone.data.payload.response.DroneBatteryDetailsResponse;
import np.com.drone.data.payload.response.DroneMedicationLoadRsponse;
import np.com.drone.data.payload.response.LoadDroneResponse;
import np.com.drone.data.payload.response.RegisterDroneResponse;
import np.com.drone.dto.DroneGetBatteryRequest;
...
import np.com.drone.service.DroneServiceImpl;
...
class TestDroneMainController {
	...
	public void testRegisterDrone() {
		...
		when(droneService.register(any(DroneDto.class))).thenReturn(registerDroneResponse);

		DroneDto drone = new DroneDto("Q23RT5676697", "Sonny", 1200.0, new BigDecimal(0.95),
				"DELIVERED");
	...
	public void testLoadDroneWithMedication() {
		...
		when(droneService.loadDrone(any(DoneLoadDto.class))).thenReturn(droneResponse);

		DoneLoadDto loadRequest = new DoneLoadDto("Q23RT5676697", "Nairobi", "Mumbai", "POQ1223465G");
